...
public:
    ...
    void retranslateUi(QMainWindow *PCLViewer)
    {
        ...
        label->setText(QApplication::translate("PCLViewer", "Red component", 0));
        label_2->setText(QApplication::translate("PCLViewer", "Green component", 0));
        label_3->setText(QApplication::translate("PCLViewer", "Blue component", 0));
        label_4->setText(QApplication::translate("PCLViewer", "Point size", 0));
        pushButton_random->setText(QApplication::translate("PCLViewer", "Random colors", 0));
    } // retranslateUi
